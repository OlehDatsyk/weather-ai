...
Hold `Ctrl` and click that link, or manually open **http://127.0.0.1:8000** in your web browser.
...
Another program (or a previous run of this app) is using port 8000. Either stop that program, or set a different port in `.env`:
```
PORT=5001
```
